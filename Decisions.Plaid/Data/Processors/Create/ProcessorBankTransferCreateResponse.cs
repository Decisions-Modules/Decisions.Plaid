...
{
    /// <summary>Defines the response schema for `/processor/bank_transfer/create`</summary>
    ...
    public  class ProcessorBankTransferCreateResponse 
    {
        ...
        public BankTransfer.BankTransfer Bank_transfer { get; set; } = new BankTransfer.BankTransfer();
