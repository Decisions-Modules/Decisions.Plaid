...
namespace Decisions.Plaid.Data.IncomeVerification.Refresh
{
    /// <summary>IncomeVerificationRequestResponse defines the response schema for `/income/verification/refresh`</summary>
