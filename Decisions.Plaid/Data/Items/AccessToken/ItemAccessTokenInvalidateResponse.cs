...
namespace Decisions.Plaid.Data.Items.AccessToken
{
    /// <summary>ItemAccessTokenInvalidateResponse defines the response schema for `/item/access_token/invalidate`</summary>
