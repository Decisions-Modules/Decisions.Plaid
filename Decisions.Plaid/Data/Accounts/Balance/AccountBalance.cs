...
namespace Decisions.Plaid.Data.Accounts.Balance
{
    ...
    public class AccountBalance 
    {
        ...
        /// <br/>
        /// <br/>For `investment`-type accounts, the `available` balance is the total cash available to withdraw as presented by the institution.
        /// <br/>
        ...
        /// <br/>
        /// <br/>If `current` is `null` this field is guaranteed not to be `null`.</summary>z
        ...
        /// <br/>
        /// <br/>For `investment`-type accounts, the current balance is the total value of assets as presented by the institution.
        /// <br/>
        ...
        /// <br/>
        /// <br/>When returned by `/accounts/balance/get`, this field may be `null`. When this happens, `available` is guaranteed not to be `null`.</summary>
        ...
        /// <br/>
        /// <br/>In North America, this field is typically only available for `credit`-type accounts.</summary>
        ...
        /// <br/>
        /// <br/>See the [currency code schema](https://plaid.com/docs/api/accounts#currency-code-schema) for a full listing of supported `unofficial_currency_code`s.</summary>
        ...
        /// <br/>
        /// <br/>This is currently only provided when the `min_last_updated_datetime` is passed when calling `/accounts/balance/get` for `ins_128026` (Capital One).</summary>
